This project templates provides:
    ...
    MyAutopilotComponentSpeedPatchCommands.cs
        - Excample class on how to create commands.
        - If no commands needed, can be safely deleted.

    MyAutopilotComponentSpeedPatchControl.xaml
    ...
    MyAutopilotComponentSpeedPatchControl.xaml.cs
